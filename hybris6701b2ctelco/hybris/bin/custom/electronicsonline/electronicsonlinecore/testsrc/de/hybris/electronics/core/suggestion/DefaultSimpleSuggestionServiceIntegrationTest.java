 ...
 */
package de.hybris.electronics.core.suggestion;
...
import de.hybris.electronics.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/electronicsonlinecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
