...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/electronicsonlinefulfilmentprocess/test/electronicsonlinefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/electronicsonlinefulfilmentprocess/test/electronicsonlinefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/electronicsonlinefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/electronicsonlinefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/electronicsonlinefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/electronicsonlinefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/electronicsonlinefulfilmentprocess/test/electronicsonlinefulfilmentprocess-spring-testcleanup.xml"));
