 ...
 */
package de.hybris.electronics.fulfilmentprocess.test.jobs;
...
import de.hybris.electronics.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ElectronicsonlineFulfilmentProcessConstants.ORDER_PROCESS_NAME;
