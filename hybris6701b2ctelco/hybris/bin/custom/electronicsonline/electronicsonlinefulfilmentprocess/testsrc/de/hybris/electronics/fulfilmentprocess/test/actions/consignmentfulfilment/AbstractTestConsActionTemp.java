 ...
 */
package de.hybris.electronics.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, ElectronicsonlineFulfilmentProcessConstants.PARENT_PROCESS);
