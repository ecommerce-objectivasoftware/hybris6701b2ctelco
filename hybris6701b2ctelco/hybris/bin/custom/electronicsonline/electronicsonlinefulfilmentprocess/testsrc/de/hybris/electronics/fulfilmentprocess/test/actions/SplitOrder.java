 ...
 */
package de.hybris.electronics.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ElectronicsonlineFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ElectronicsonlineFulfilmentProcessConstants.PARENT_PROCESS);
