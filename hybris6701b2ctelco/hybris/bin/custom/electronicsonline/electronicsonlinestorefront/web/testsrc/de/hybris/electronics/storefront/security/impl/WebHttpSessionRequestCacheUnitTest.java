...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsonlinestorefront/electronics/en",
						"https://electronics.local:9002/electronicsonlinestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsonlinestorefront/electronics/en",
						"https://electronics.local:9002/electronicsonlinestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/electronicsonlinestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/electronicsonlinestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/electronicsonlinestorefront/electronics/en",
						"https://electronics.local:9002/electronicsonlinestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/electronicsonlinestorefront",
						"https://electronics.local:9002/electronicsonlinestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/electronicsonlinestorefront",
						"https://electronics.local:9002/electronicsonlinestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsonlinestorefront/electronics/en",
						"https://electronics.local:9002/electronicsonlinestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
