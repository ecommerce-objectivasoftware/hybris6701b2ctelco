 ...
 */
package de.hybris.electronics.test.setup;
...
import de.hybris.electronics.test.constants.ElectronicsonlineTestConstants;
import de.hybris.electronics.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ElectronicsonlineTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/electronicsonlinetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/electronicsonlinetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/electronicsonlinetest/import/cstickets.impex");
			...
			importImpexFile(context, "/electronicsonlinetest/import/csquotes.impex");
		}
	}
}
